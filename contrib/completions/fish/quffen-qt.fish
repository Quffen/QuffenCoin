...
complete --command quffen-qt --no-files

# Extract options
function __fish_quffenqt_get_options
...
complete \
    --command quffen-qt \
    --arguments "(__fish_quffenqt_get_options --nofiles)"
