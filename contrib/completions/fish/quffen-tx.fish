...
# Extract options
function __fish_quffen_tx_get_options
...
# Extract commands
function __fish_quffen_tx_get_commands
...
complete \
    --command quffen-tx \
    --condition "not __fish_quffen_seen_cmd (__fish_quffen_tx_get_commands --commandsonly)" \
    --arguments "(__fish_quffen_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command quffen-tx \
    --arguments "(__fish_quffen_tx_get_commands)" \
    --no-files
