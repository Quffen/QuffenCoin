...
"""Example logging Quffen Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/quffend
...
def main(quffend_path):
    ...
    b = BPF(text=program, usdt_contexts=[quffend_with_usdts])
