...
""" Interactive quffend P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Quffen Core can enable. It uses BCC
...
def main(quffend_path):
    ...
    quffend_with_usdts.enable_probe(
