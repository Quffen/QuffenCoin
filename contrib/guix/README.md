...
This directory contains the files necessary to perform bootstrappable Quffen
Core builds.
...
To build Quffen Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Quffen Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/quffen-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/quffen-core/guix.sigs).
