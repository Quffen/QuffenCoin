...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QUFFEN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QUFFEN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the quffen network\n')
    ...
    g.write('#endif // QUFFEN_CHAINPARAMSSEEDS_H\n')
