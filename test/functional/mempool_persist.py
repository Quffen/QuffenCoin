...
By default, quffend will dump mempool on shutdown and
...
class MempoolPersistTest(QuffenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent quffend from writing mempool.dat to disk. Verify that `savemempool` fails")
