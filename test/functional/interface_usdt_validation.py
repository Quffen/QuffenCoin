...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/quffen/quffen/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(QuffenTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/quffen/quffen/blob/master/doc/tracing.md#tracepoint-validationblock_connected
