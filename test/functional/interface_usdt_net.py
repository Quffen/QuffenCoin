...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/quffen/quffen/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(QuffenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our quffend node")
