...
class NetTest(QuffenTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=15842)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 15842)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=15842), {"success": False})
