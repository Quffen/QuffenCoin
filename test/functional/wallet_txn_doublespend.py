...
class TxnMallTest(QuffenTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 QFN:
        ...
        # First: use raw transaction API to send 1240 QFN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 QFN coin each
        ...
        # Node0's balance should be starting balance, plus 50QFN for another
        ...
        # Node0's total balance should be starting balance, plus 100QFN for
