...
class TransactionTimeRescanTest(QuffenTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine QFN and create transactions
        ...
        # generate some qfn to create transactions and check blockcount
        ...
        # send 10 qfn to user's first watch-only address
        self.log.info('Send 10 qfn to user')
        ...
        # send 5 qfn to our second watch-only address
        self.log.info('Send 5 qfn to user')
        ...
        # send 1 qfn to our third watch-only address
        self.log.info('Send 1 qfn to user')
