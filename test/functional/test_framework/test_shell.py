...
class TestShell:
    """Wrapper Class for QuffenTestFramework.

    The TestShell class extends the QuffenTestFramework
    ...
    class __TestShell(QuffenTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QuffenTestFramework child class.
            self.num_nodes = 1
