...
"""Verify that starting quffen with -h works as expected."""

from test_framework.test_framework import QuffenTestFramework
from test_framework.util import assert_equal

class HelpTest(QuffenTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quffen with -h for help text")
        ...
        self.log.info("Start quffen with -version for version information")
        ...
        self.log.info("Start quffend with -fakearg to make sure it does not start")
