...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QuffenTestFramework
    pass


class ExampleTest(QuffenTestFramework):
    # Each functional test is a subclass of the QuffenTestFramework class.
    ...
    def custom_method(self):
        ...
        QuffenTestFramework class so other tests can use it."""
