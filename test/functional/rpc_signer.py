...
Verify that a quffend node can use an external signer command.
...
class RPCSignerTest(QuffenTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart quffend with -signer=<cmd>',
