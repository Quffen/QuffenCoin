...
#ifndef QUFFEN_WALLET_SCRIPTPUBKEYMAN_H
#define QUFFEN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Quffen Core wallet was originally a collection of unrelated private
...
#endif // QUFFEN_WALLET_SCRIPTPUBKEYMAN_H
