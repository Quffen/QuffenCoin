...
#ifndef QUFFEN_WALLET_WALLETUTIL_H
#define QUFFEN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! quffen from opening the wallet, thinking it was newly created, and
...
#endif // QUFFEN_WALLET_WALLETUTIL_H
