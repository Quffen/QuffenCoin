...
#ifndef QUFFEN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define QUFFEN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // QUFFEN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
