...
#ifndef QUFFEN_WALLET_TRANSACTION_H
#define QUFFEN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this quffen node, and set to 0 for transactions that were created
...
#endif // QUFFEN_WALLET_TRANSACTION_H
