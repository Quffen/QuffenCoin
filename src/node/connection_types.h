...
#ifndef QUFFEN_NODE_CONNECTION_TYPES_H
#define QUFFEN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/quffen-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Quffen’s Peer-to-Peer Network")
...
#endif // QUFFEN_NODE_CONNECTION_TYPES_H
