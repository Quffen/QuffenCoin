...
#ifndef QUFFEN_CRYPTO_CHACHA_POLY_AEAD_H
#define QUFFEN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@quffen.
 *
 ...
 *
 * The chacha20-poly1305@quffen combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@quffen cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@quffen are relatively fast in
...
#endif // QUFFEN_CRYPTO_CHACHA_POLY_AEAD_H
