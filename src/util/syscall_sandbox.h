...
#ifndef QUFFEN_UTIL_SYSCALL_SANDBOX_H
#define QUFFEN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during quffend initialization if Quffen Core was compiled
...
#endif // QUFFEN_UTIL_SYSCALL_SANDBOX_H
