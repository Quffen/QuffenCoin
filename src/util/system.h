 ...
 */
#ifndef QUFFEN_UTIL_SYSTEM_H
#define QUFFEN_UTIL_SYSTEM_H
...
extern const char * const QUFFEN_CONF_FILENAME;
extern const char * const QUFFEN_SETTINGS_FILENAME;
