...
#ifndef QUFFEN_INTERFACES_NODE_H
#define QUFFEN_INTERFACES_NODE_H
...
//! Top-level interface for a quffen node (quffend process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or quffen.conf.
...
#endif // QUFFEN_INTERFACES_NODE_H
