...
#ifndef QUFFEN_INTERFACES_INIT_H
#define QUFFEN_INTERFACES_INIT_H
...
//! (quffen-gui, quffen-node, quffen-wallet, quffend, quffen-qt) and each
...
#endif // QUFFEN_INTERFACES_INIT_H
