...
{
    BOOST_CHECK(TestSplitHost("www.quffencore.org", "www.quffencore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.quffencore.org]", "www.quffencore.org", 0));
    BOOST_CHECK(TestSplitHost("www.quffencore.org:80", "www.quffencore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.quffencore.org]:80", "www.quffencore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:15842", "127.0.0.1", 15842));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:15842", "127.0.0.1", 15842));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:15842", "::ffff:127.0.0.1", 15842));
    BOOST_CHECK(TestSplitHost("[::]:15842", "::", 15842));
    BOOST_CHECK(TestSplitHost("::15842", "::15842", 0));
    BOOST_CHECK(TestSplitHost(":15842", "", 15842));
    BOOST_CHECK(TestSplitHost("[]:15842", "", 15842));
    ...
    BOOST_CHECK(TestSplitHost("www.quffencore.org:65536", "www.quffencore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.quffencore.org:0", "www.quffencore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.quffencore.org:", "www.quffencore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:15842", "127.0.0.1:15842"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:15842", "[::]:15842"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
