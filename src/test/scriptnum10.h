...
#ifndef QUFFEN_TEST_SCRIPTNUM10_H
#define QUFFEN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Quffen Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // QUFFEN_TEST_SCRIPTNUM10_H
