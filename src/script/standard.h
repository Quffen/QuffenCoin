...
#ifndef QUFFEN_SCRIPT_STANDARD_H
#define QUFFEN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a quffen address
 */
...
/**
 * Generate a Quffen scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // QUFFEN_SCRIPT_STANDARD_H
