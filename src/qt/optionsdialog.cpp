      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->quffenAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->quffenAtStartup);
    ...
    ui->quffenAtStartup->setToolTip(ui->quffenAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->quffenAtStartup->setText(ui->quffenAtStartup->text().arg(PACKAGE_NAME));

    ui->openQuffenConfButton->setToolTip(ui->openQuffenConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QuffenUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->quffenAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSQFNontrols);
...
void OptionsDialog::on_openQuffenConfButton_clicked()
{
