...
#ifndef QUFFEN_QT_GUIUTIL_H
#define QUFFEN_QT_GUIUTIL_H
...
/** Utility functions used by the Quffen Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "quffen:" URI into recipient object, return true on successful parsing
