...
//! Entry point for QuffenApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QuffenApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QuffenGUI tests.
void AppTests::guiTests(QuffenGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QuffenGUI::consoleShown, this, &AppTests::consoleTests);
