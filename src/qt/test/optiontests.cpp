...
{
    // Test regression https://github.com/quffen/quffen/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/quffen-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/quffen-core/gui/pull/568.
    // With fListen=false in ~/.config/Quffen/Quffen-Qt.conf and all else left as default,
    // quffen-qt should set both -listen and -listenonion to false and start successfully.
