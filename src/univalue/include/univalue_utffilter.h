...
#ifndef QUFFEN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define QUFFEN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // QUFFEN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
