...
#ifndef QUFFEN_RPC_PROTOCOL_H
#define QUFFEN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in quffend
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Quffen is not connected
