...
#ifndef QUFFEN_COMPAT_ASSUMPTIONS_H
#define QUFFEN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Quffen cannot be compiled without assertions."
#endif
...
#endif // QUFFEN_COMPAT_ASSUMPTIONS_H
