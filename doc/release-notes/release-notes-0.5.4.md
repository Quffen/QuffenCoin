Quffen version 0.5.4 is now available for download at:
http://sourceforge.net/projects/quffen/files/Quffen/quffen-0.5.4/
...
http://gitorious.org/quffen/quffend-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Quffen-Qt notifications under Growl 1.3.
Increase required age of Quffen-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQuffen properly when installing Quffen-Qt over it. (Windows)
