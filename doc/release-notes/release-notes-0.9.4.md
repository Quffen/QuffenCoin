Quffen Core version 0.9.4 is now available from:

  https://quffen.org/bin/0.9.4/
...
this update is incompatible with the Quffen system and could lead to consensus
forks.

Quffen Core released binaries from https://quffen.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~quffen/+archive/ubuntu/quffen
- A third-party or self-compiled Quffen Core

upgrade to Quffen Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
