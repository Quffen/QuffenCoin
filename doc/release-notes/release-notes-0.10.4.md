Quffen Core version 0.10.4 is now available from:

  <https://quffen.org/bin/quffen-core-0.10.4/>
...
- #6953 `43c2789` Split quffen-tx into its own package
- #6953 `dfe0d4d` Include quffen-tx binary on Debian/Ubuntu
