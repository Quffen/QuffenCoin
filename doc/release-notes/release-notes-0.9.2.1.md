Quffen Core version 0.9.2.1 is now available from:

  https://quffen.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 QFN to 0.01 QFN
...
- Fix "Start quffen on system login"
