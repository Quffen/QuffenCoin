Quffen Core version 0.13.2 is now available from:

  <https://quffen.org/bin/quffen-core-0.13.2/>
...
- #8908 `4a974b2` Update quffen-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow quffen-tx to create v2 transactions (qfndrak)
