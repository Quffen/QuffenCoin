Quffen Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/quffen-core-0.16.1/>
...
- #12843 `df38b13` Test starting quffend with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure quffend processes are cleaned up when tests end (sdaftuar)
