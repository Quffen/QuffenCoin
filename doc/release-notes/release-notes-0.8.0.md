Quffen-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/quffen/files/Quffen/quffen-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Quffen
...
New/changed settings (command-line or quffen.conf file)
--------------------------------------------------------
